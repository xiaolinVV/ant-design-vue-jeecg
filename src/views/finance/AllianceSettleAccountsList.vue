<template>
  <a-card :bordered="false">
    ...
    <!--<div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('加盟商提现')">导出</a-button>
    ...
    <div>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a v-if="record.status == '0'" @click="showAudiModal(record.id)">审核</a>
          <a-divider v-if="record.status == '1'" type="vertical" />
          <a v-if="record.status == '1'" @click="showEemitModal(record.id)">打款</a>
        </span>
      </a-table>
    </div>
    <!-- table区域-end -->
...
<script>
import AllianceSettleAccountsModal from '../alliance/modules/AllianceSettleAccountsModal'
...
export default {
  ...
  methods: {
    ...
    /**打款弹窗*/
    showEemitModal(id) {
      this.$refs.modalForm.showEemitModal(id)
