...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download"  :loading="exportLoading"  @click="handleExportXls('称号出账资金')">导出</a-button>
      ...
      <a-table
        ...
        <template slot="tradeType" slot-scope="text, record, index">
          <div class="anty-img-wrap">
            <span shape="square" v-if="record.tradeType==0">称号分红</span>
          </div>
        </template>
    ...
    <!-- 表单区域 -->
    <marketingEnterMoney-modal ref="modalForm" @ok="modalFormOk"></marketingEnterMoney-modal>
  </a-card>
</template>

<script>
  import MarketingEnterMoneyModal from './modules/MarketingEnterMoneyModal'
  import {JeecgListMixin} from '@/mixins/JeecgListMixin'
  import {filterObj} from '@/utils/util';
  import { getAction } from '@/api/manage'
  export default {
    name: "MarketingEnterMoneyList",
    mixins: [JeecgListMixin],
    components: {
      MarketingEnterMoneyModal
    },
    data () {
      return {
        description: '称号出账资金管理页面',
        titleList:[],
        // 表头
        columns: [
          {
        ...
        url: {
          list: "/marketingEnterMoney/marketingEnterMoney/list",
          delete: "/marketingEnterMoney/marketingEnterMoney/delete",
          deleteBatch: "/marketingEnterMoney/marketingEnterMoney/deleteBatch",
          exportXlsUrl: "marketingEnterMoney/marketingEnterMoney/exportXls",
          importExcelUrl: "marketingEnterMoney/marketingEnterMoney/importExcel",
