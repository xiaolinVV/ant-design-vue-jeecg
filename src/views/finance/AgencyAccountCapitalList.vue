<template>
  <div>
    <a-card :bordered="false">
      <!--代理余额-->
      <!--<div>&lt;!&ndash;v-if="agencyManage"&ndash;&gt;
...
结算时钱会从待结算中扣除进入店铺余额" type="question-circle"/>
        ...
        <div style="margin-bottom: 40px">
          ...
          &lt;!&ndash;<a-button type="primary" @click="Recharge(agencyManage.id,agencyManage.balance)" >充值</a-button>&ndash;&gt;
...
<script>
  import AgencyRechargeRecordModal from '../agency/modules/AgencyRechargeRecordModal'
