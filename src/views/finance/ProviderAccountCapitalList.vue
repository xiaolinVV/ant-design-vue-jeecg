<template>
  <a-card :bordered="false">
    <!--店铺余额-->
    <!--<div >&lt;!&ndash;v-if="providerManage"&ndash;&gt;
...
结算时钱会从待结算中扣除进入店铺余额" type="question-circle" />
    ...
    <div class="table-operator">
      ...
      <!--<a-button type="primary" icon="download" @click="handleExportXls('供应商余额明细')">导出</a-button>-->
...
<script>
  import ProviderRechargeRecordModal from '../provider/modules/ProviderRechargeRecordModal'
