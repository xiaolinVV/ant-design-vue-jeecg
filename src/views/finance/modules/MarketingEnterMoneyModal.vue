      ...
      <a-spin :spinning="confirmLoading">
        <a-form :form="form">
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="交易类型；0：称号分红">
            <a-input placeholder="请输入交易类型；0：称号分红" v-decorator="['tradeType', {}]" />
          </a-form-item>
          <a-form-item
            :labelCol="labelCol"
            :wrapperCol="wrapperCol"
            label="出账资金">
            <a-input-number v-decorator="[ 'enterMoney', {}]" />
          </a-form-item>
          <a-form-item
            :labelCol="labelCol"
            :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        loading:false,
        url: {
          add: "/marketingEnterMoney/marketingEnterMoney/add",
          edit: "/marketingEnterMoney/marketingEnterMoney/edit",
          getAgencyAccountCapitalListList:"/marketingEnterMoney/marketingEnterMoney/checkTheDetails",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','memberDesignationId','tradeType','enterMoney','balance'))
		  //时间格式化
