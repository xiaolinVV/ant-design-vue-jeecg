  ...
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="商品名称">
              <a-input placeholder="请输入" v-model="queryParam.goodName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
    ...
    <div style="">
      ...
      <a-table
        ...
        <template slot="auditExplain" slot-scope="text, record, index">
          <div class="anty-img-wrap">
            <span shape="square" v-if="record.auditExplain" >{{ record.auditExplain }}</span>
  ...
  export default {
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            scopedSlots: {customRender: "auditExplain"}
          },
          {
            title: '创建者',
            align:"center",
    ...
    methods: {
      ...
      batchAudit: function (FrameStatus) {
        if(!this.url.updateAuditStatus){
          this.$message.error("请设置url.updateAuditStatus属性!")
          return
        }
