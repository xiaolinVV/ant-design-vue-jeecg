<template>
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            <a-form-item style="display: flex;" label="商品分类">
              ...
              <a-select
                ...
                <!--:defaultValue="listGoodType1.length>0?listGoodType1[0].name : ''"--> </a-select
            ...
            <a-col :md="6" :sm="8">
              <a-form-item label="店铺分店名称">
                <a-input placeholder="请输入店铺分店名称" v-model="queryParam.subStoreName"></a-input>
              </a-form-item>
            </a-col>
            ...
            <a-col :md="6" :sm="8">
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="活动">
                <j-dict-select-tag
                  v-model="queryParam.activitiesType"
                  placeholder="请选择"
                  dictCode="activities_type"
                />
              </a-form-item>
            </a-col>
            <!--时间选择框-->
    ...
    <div class="table-operator">
      ...
      <!--<a-button type="primary" icon="download" @click="handleExportXls('店铺商品列表')">导出</a-button>
    ...
    <div style="">
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-divider type="vertical" />
          <a v-if="record.status == 1" @click="showModalStopStatus(record.id)">停用</a>
    ...
    <good-Store-list-price-modal ref="modalForm1" @ok="modalFormOk"></good-Store-list-price-modal>
  </a-card>
</template>

<script>
import GoodStoreListModal from './modules/GoodStoreListModal'
import GoodStoreListPriceModal from './modules/GoodStoreListPriceModal'
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          customRender: function(frameExplain) {
            if (frameExplain) {
              return frameExplain
            } else {
              return '-'
        ...
        },
        {
          ...
          customRender: function(auditExplain) {
            if (auditExplain) {
              return auditExplain
            } else {
              return '-'
        ...
        },
        {
          ...
          customRender: function(statusExplain) {
            if (statusExplain) {
      ...
      url: {
        ...
        getGoodUrl: '/goodStoreList/goodStoreList/getGoodUrl'
      }
    }
  },
  computed: {
  ...
  methods: {
    ...
    updateStatus: function(id) {
      ...
      this.$confirm({
        ...
        content: '您确定要启用吗？',
        onOk: function() {
          getAction(that.url.updateStatus, { id: id, statusExplain: '' }).then(res => {
            if (res.success) {
