        ...
        <a-card title="商品信息">
          <div v-if="goodSetting.openGoodType == 1">
            <a-form-model-item
              ...
              v-if="goodTypes['1']"
            >
              <span>{{ goodTypes['1'].name }}>{{ goodTypes['2'].name }}>{{ goodTypes['3'].name }}</span
              ><a
          ...
          <a-form-model-item
            ...
            prop="goodNo"
            label="商品品牌"
            v-if="goodSetting.openBrand == 1"
          >
            <a-select
              showSearch
              :options="goodBrandOption"
              :filterOption="filterOption"
              v-model="model.goodBrandId"
            ></a-select>
          </a-form-model-item>
              ...
              <a-card style="background-color: #cccccc">
                    ...
                    <template slot="vipPrice" slot-scope="text, record, index">
                      ...
                      <div v-if="goodSetting.openMemberGrade == 1">
                        ...
                        <div v-if="memberGradeList.length >= 2">
                          ...
                          <a-input
                            v-model="specificationsDecribes[index].vipTwoPrice"
                            @input="vipTwoPriceChange"
                          ></a-input>
                        </div>
                        <div v-if="memberGradeList.length >= 3">
                          {{ memberGradeList[2].gradeName }}：
                          <a-input
                            v-model="specificationsDecribes[index].vipThirdPrice"
                            @input="vipThirdPriceChange"
                          ></a-input>
                        </div>
                        <div v-if="memberGradeList.length >= 4">
                          {{ memberGradeList[3].gradeName }}：
                          <a-input
                            v-model="specificationsDecribes[index].vipFouthPrice"
                            @input="vipFouthPriceChange"
                          ></a-input>
                        </div>
                      </div>
                    </template>
                ...
                >
                  ...
                  <template slot="vipPrice" slot-scope="text, record">
                    ...
                    <div v-if="goodSetting.openMemberGrade == 1">
                      <div v-if="memberGradeList.length >= 1">
                        {{ memberGradeList[0].gradeName }}：<a-input
                          v-model="shopInfo[0].vipPrice"
        ...
        <a-card title="服务承诺" style="margin-top: 30px">
          ...
          <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" prop="sysUserId" label="供应商">
            <a-select
              ...
              :options="sysUserList"
              :filterOption="filterOption"
              v-model="model.sysUserId"
              @select="changeSysUser"
            ></a-select>
          </a-form-model-item>
          ...
          <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" prop="providerTemplateId" label="运费模板">
            <a-select
              ...
              :filterOption="filterOption"
              v-model="model.providerTemplateId"
              @select="sdfgsdfg"
            ></a-select>
          </a-form-model-item>
          ...
          <a-form-model-item
            ...
            :wrapperCol="wrapperCol"
            label="适用整机品牌"
            v-if="goodSetting.machineParts == 1"
          >
            <a-select
              showSearch
              mode="multiple"
              :options="goodMachineBrandOption"
              :filterOption="filterOption"
              v-model="goodMachineBrandIds"
            ></a-select>
          </a-form-model-item>
          ...
          >
            <a-select
              showSearch
              mode="multiple"
              :options="goodMachineModelOption"
              :filterOption="filterOption"
              v-model="goodMachineModelIds"
            ></a-select>
          </a-form-model-item>
