  ...
  <j-modal
    ...
    <a-spin :spinning="confirmLoading" >
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        <a-card title="商品信息">
          <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" prop="goodTypeId" label="店铺名称" v-if="goodTypes['1']">
            {{storeInfo.title}}
          </a-form-model-item>
          <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" prop="goodTypeId" label="商品分类" v-if="goodTypes['1']">
            <span>{{goodTypes['1'].name}}>{{goodTypes['2'].name}}</span><a style="margin-left: 30px"  @click="()=>{drawerVisible=true;getStoreGoodTypeByTree();}">修改分类</a>
          </a-form-model-item>
          <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" prop="goodTypeId" label="商品分类" v-else>
            <span>请选择分类</span><a style="margin-left: 30px" @click="()=>{drawerVisible=true;getStoreGoodTypeByTree();}">修改分类</a>
          </a-form-model-item>
        ...
        <a-card title="服务承诺" style="margin-top: 30px">
          ...
          <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" prop="storeTemplateId" label="运费模板">
            <a-select showSearch :options="providerTemplateOption" :filterOption="filterOption" v-model="model.storeTemplateId" @select="sdfgsdfg"></a-select>
          </a-form-model-item>
