<template>
  <a-card :bordered="false">
    ...
    <!--<div class="table-operator">
      ...
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('加盟商资金管理')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <allianceAccountCapital-modal ref="modalForm" @ok="modalFormOk"></allianceAccountCapital-modal>
  </a-card>
</template>

<script>
  import AllianceAccountCapitalModal from './modules/AllianceAccountCapitalModal'
  import {JeecgListMixin} from '@/mixins/JeecgListMixin'
  import { filterObj } from '@/utils/util';
  import {getAction, postAction} from '@/api/manage'
  export default {
    name: "AllianceAccountCapitalList",
    mixins: [JeecgListMixin],
    components: {
      AllianceAccountCapitalModal
    },
    data () {
      return {
        description: '加盟商资金管理管理页面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          list: "/allianceAccountCapital/allianceAccountCapital/list",
          delete: "/allianceAccountCapital/allianceAccountCapital/delete",
          deleteBatch: "/allianceAccountCapital/allianceAccountCapital/deleteBatch",
          exportXlsUrl: "allianceAccountCapital/allianceAccountCapital/exportXls",
          importExcelUrl: "allianceAccountCapital/allianceAccountCapital/importExcel",
        },
      }
    },
    computed: {
