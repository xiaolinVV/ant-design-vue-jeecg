      ...
      <a-table
        ...
        <template slot="headPortrait" slot-scope="text, record, index">
          <div class="anty-img-wrap">
            <a-avatar shape="square" :src="record.headPortrait" icon="user"/>
          </div>
        </template>
        <template slot="ssAddress" slot-scope="text, record, index">
          <div class="anty-img-wrap">
            <a-avatar shape="square" :src="ssAddressView(record.ssAddress)" icon="user"/>
          </div>
        </template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/memberList/memberList/findAllianceStoreList",
