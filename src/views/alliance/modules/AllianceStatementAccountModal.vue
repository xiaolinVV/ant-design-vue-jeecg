...
<script>
  ...
  export default {
    components: {AModal},
    name: "AllianceStatementAccountModal",
    data () {
      return {
        title:"操作",
        visible: false,
        ...
        url: {
          add: "/allianceStatementAccount/allianceStatementAccount/add",
          edit: "/allianceStatementAccount/allianceStatementAccount/edit",
          findAccountCapitalById:"/allianceStatementAccount/allianceStatementAccount/findAccountCapitalById",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      handleTableChange(pagination){
        ...
        this.$nextTick(()=>{
          this.showModalParticularsInformation()
        })
      },
      handleOk () {
        const that = this;
      ...
      showModalParticularsInformation(id = this.particularsInformationId){
        this.visiblParticularsInformation = true;
        this.loading = true
        this.particularsInformationId = id
        getAction(this.url.findAccountCapitalById,{id: id,pageNo:this.ipagination.current,pageSize:this.ipagination.pageSize}).then((res) => {
          if (res.success) {
