    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          <a-input placeholder="请输入交易类型：0：订单交易；1：财务结算；2：订单退款；3：开店奖励；4：礼包分成；5：福利金销售奖励；6：兑换券销售奖励；7：推荐供应商销售奖励；做成数据字典agency_deal_type" v-decorator="['payType', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
...
<script>
  ...
  export default {
    name: "AllianceAccountCapitalModal",
    data () {
      return {
        title:"操作",
        visible: false,
        ...
        url: {
          add: "/allianceAccountCapital/allianceAccountCapital/add",
          edit: "/allianceAccountCapital/allianceAccountCapital/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','sysUserId','payType','goAndCome','amount','orderNo','balance'))
		  //时间格式化
        });
