<template>
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :md="8" :sm="8">
              <a-form-item label="会员类型">
                <j-dict-select-tag v-model="queryParam.memberType" placeholder="请选择会员类型" dictCode="member_type" />
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="8">
            ...
            <a-col :md="8" :sm="8">
              <a-form-item label="创建时间">
                <a-range-picker style="width: 100%" v-model="queryParam.createTime" format="YYYY-MM-DD"
                  :placeholder="['开始时间', '结束时间']" @change="onDateChange" />
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="8">
              <a-form-item label="开通vip时间">
                <a-range-picker style="width: 100%" v-model="queryParam.vipTime" format="YYYY-MM-DD"
                  :placeholder="['开始时间', '结束时间']" @change="onDateChange1" />
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="8">
            ...
            <a-col :md="8" :sm="8">
              <a-form-item label="会员称号">
                <a-select v-model="queryParam.memberDesignationId" placeholder="请选择会员称号">
                  <a-select-option :value="item.memberDesignationId" v-for="(item, index) in membershipTitleOptions"
    ...
    <div>
      ...
      <a-table ref="table" size="middle" :scroll="{ x: 3500 }" rowKey="id" :columns="columns" bordered
    ...
    <memberListModal ref="modalForm" @ok="modalFormOk"></memberListModal>
  </a-card>
</template>
