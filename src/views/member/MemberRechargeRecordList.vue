...
结算时钱会从待结算中扣除进入店铺余额" type="question-circle"/>
    ...
    <!--<div class="table-operator">
      ...
      <a-button type="primary" icon="download"  :loading="exportLoading"  @click="handleExportXls('会员余额明细')">导出</a-button>
...
<script>
  import MemberRechargeRecordModal from './modules/MemberRechargeRecordModal'
  import {JeecgListMixin} from '@/mixins/JeecgListMixin'
  import {filterObj} from '@/utils/util';
  import {httpAction, getAction} from '@/api/manage'
  export default {
    name: "MemberRechargeRecordList",
