    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="说明">
          <a-input placeholder="请输入说明" v-decorator="['explain', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
...
<script>
  ...
  export default {
    name: "MemberWelfarePaymentsModal",
    data () {
      return {
        title:"操作",
        visible: false,
        ...
        url: {
          add: "/memberWelfarePayments/memberWelfarePayments/add",
          edit: "/memberWelfarePayments/memberWelfarePayments/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','memberListId','serialNumber','bargainPayments','welfarePayments','weType','explain','goAndCome','operator'))
		  //时间格式化
