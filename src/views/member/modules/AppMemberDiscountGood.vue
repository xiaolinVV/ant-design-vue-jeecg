<template>
  <div>
    ...
    >
      ...
      <!--      :scroll="{y:600}"-->
      <a-table bordered :dataSource="dataSource" :columns="columns" :pagination="{pageSize:5}" :scroll="{y:600,x:1500}"
  ...
  export default {
    ...
    data(){
      return {
        ...
        url: {
          //适用商品返显
          findByMarketingDiscount: '/memberList/memberList/getMemberDiscountGood',
        },
        //配置
        configure: {
    ...
    methods: {
      ...
      //显示弹窗
      showModalVisible(id,isPlatform){
        this.loading = true
        let that = this;
        let info = {
