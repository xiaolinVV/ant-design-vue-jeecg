<template>
  <div>
    ...
    <a-modal title="删除" v-model="visibleDelete" @ok="hideModal()" okText="确认" cancelText="取消">
      ...
      <h3>删除该等级后，该等级无效，对应特权无效，删除后不可恢复</h3>
      <p>您确定要删除吗？</p>
      <a-textarea
        placeholder="请输入删除说明"
        v-model="closeExplain"
...
<script>
  ...
  export default {
    name: 'memberGradeListStopOrStartModal',
    data(){
      return{
        ...
        url: {
          ...
          //删除接口
          delete: "/memberGrade/memberGrade/deleteAndExplain",
        }
      }
    },
    methods:{
