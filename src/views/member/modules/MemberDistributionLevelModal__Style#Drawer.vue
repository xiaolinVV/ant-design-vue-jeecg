    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="分销等级id">
          <a-input placeholder="请输入分销等级id" v-decorator="['marketingDistributionLevelId', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="分销升级直推">
          <a-input-number v-decorator="[ 'upgradeDirect', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="分销升级团队">
          <a-input-number v-decorator="[ 'upgradeTeamNumber', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','memberListId','direct','teamNumber','marketingDistributionLevelId','upgradeDirect','upgradeTeamNumber'))
		  //时间格式化
        });
