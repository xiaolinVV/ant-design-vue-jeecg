    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item
          ...
          label="联系人">
          <a-input placeholder="请输入联系人" v-decorator="['contactName', {rules:[{ required: true, message: '请输入联系人' }]}]"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="手机号">
          <a-input placeholder="请输入手机号" v-decorator="['contactPhone',  {rules:[{ required: true, message: '请输入手机号' }]}]"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="电话号">
          <a-input placeholder="请输入电话号" v-decorator="['contactTelephone',{rules:[{ required: true, message: '请输入电话号' }]}]"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="所在城市"
        >
          <a-cascader :options="cityAllData" @change="cityAllDataChange" :loadData="cityAllDataLoad" changeOnSelect  v-if="canShowDefaultCity" :defaultValue='defaultCity'  placeholder="请选择区域" />
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="详细地址">
          <a-input placeholder="请输入详细地址" v-decorator="['detailedAddress',  {rules:[{ required: true, message: '请输入详细地址' }]}]"/>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        form: this.$form.createForm(this, { name: 'storeAddress' }),
        validatorRules: {},
        RadioGroup: 1,
        isPeisong: '1',
        ...
        url: {
          add: "/storeAddress/storeAddress/add",
          edit: "/storeAddress/storeAddress/edit",
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model, 'year', 'month', 'day', 'delFlag', 'storeManageId', 'sysAreaId', 'areaAddress', 'detailedAddress', 'isDeliver', 'isReturn', 'contactName', 'contactPhone', 'contactTelephone'))
          //时间格式化
        });
