    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="系列管理id">
          <a-input placeholder="请输入系列管理id" v-decorator="['storeSeriesManageId', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="图片">
          <a-input placeholder="请输入图片" v-decorator="['picture', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="跳转类型；0：无；2：店铺">
          <a-input placeholder="请输入跳转类型；0：无；2：店铺" v-decorator="['jumpType', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="跳转">
          <a-input placeholder="请输入跳转" v-decorator="['jumpId', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','storeSeriesManageId','advertisingTitle','picture','jumpType','jumpId','sort','status','statusExplain'))
		  //时间格式化
