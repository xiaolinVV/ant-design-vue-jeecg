        ...
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="是否开启" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="productWholesaleStatus">
              <j-switch v-model="model.productWholesaleStatus"  ></j-switch>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="仅经销商" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="productWholesaleOnlyFranchiser">
              <j-switch v-model="model.productWholesaleOnlyFranchiser"  ></j-switch>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="仅代理商" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="productWholesaleOnlyAgency">
              <j-switch v-model="model.productWholesaleOnlyAgency"  ></j-switch>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
