<template>
  <a-card :bordered="false">
    ...
    <!--<div class="table-operator">
      ...
      <a-button type="primary" icon="download"  :loading="exportLoading"  @click="handleExportXls('店铺银行卡')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <!--<storeBankCard-modal ref="modalForm" @ok="modalFormOk"></storeBankCard-modal>-->
    <publicCorrespondentCardsEditModal
      ref="modalForm"
      @ok="modalFormOk"
      urlEditName="storeBankCard/storeBankCard/edit"
    ></publicCorrespondentCardsEditModal>
  </a-card>
</template>
