      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <!--    todo 联系人查询过滤无效  @zhangshaolin-->
            <a-form-item label="联系人">
              <j-input placeholder="请输入联系人" v-model="queryParam.bossName"></j-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="联系人手机">
              <j-input placeholder="请输入联系人手机" v-model="queryParam.bossPhone"></j-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="开通类型">
              <j-dict-select-tag placeholder="请选择开通类型" v-model="queryParam.openType" dictCode="store_payment_open_type"/>
            </a-form-item>
          </a-col>
          <div v-if="toggleSearchStatus">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="流水号">
                <j-input placeholder="请输入流水号" v-model="queryParam.id"></j-input>
              </a-form-item>
            </a-col>
          </div>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
