  ...
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <!-- <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>
        <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('供应商资金流水')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <providerAccountCapital-modal ref="modalForm" @ok="modalFormOk"></providerAccountCapital-modal>
  </a-card>
</template>

<script>
  import ProviderAccountCapitalModal from './modules/ProviderAccountCapitalModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
  import {filterObj} from '@/utils/util';
  export default {
    name: "ProviderAccountCapitalList",
    mixins:[JeecgListMixin],
    components: {
      ProviderAccountCapitalModal
    },
    data () {
      return {
        description: '供应商资金流水管理页面',
        // 表头
        columns: [
          {
            title: '#',
		...
		url: {
          list: "/providerAccountCapital/providerAccountCapital/list",
          delete: "/providerAccountCapital/providerAccountCapital/delete",
          deleteBatch: "/providerAccountCapital/providerAccountCapital/deleteBatch",
          exportXlsUrl: "providerAccountCapital/providerAccountCapital/exportXls",
          importExcelUrl: "providerAccountCapital/providerAccountCapital/importExcel",
       },
    }
  },
  computed: {
