<!--新增运费模板-->
<template>
  <div class="PlatformTemplateModel" ref="PlatformTemplateModel">
    ...
    <div>
      ...
      >
        <a-select style="width: 150px"
                  ...
                  placeholder="请选择"
                  @change="selectSupply"
                  :defaultValue="AllData.sysUserId"
        >
          <a-select-option v-for="item in sysUserDTOs"  :key="item.id" :value="item.id">
            {{ item.realname }}
          </a-select-option>
        </a-select>
      </a-form-item>
        ...
        <div class="card-content" v-for="(item,index) in PostageArea">
          ...
          <div class="ipt-cnt" v-show="item.isDelivery == 1">
            ...
            <div>
              ...
              <a-input-number :min="0" v-model="item.price" placeholder="请输入" type="number"/>
              <span>
                元
              </span>
            ...
            <div>
              ...
              <a-input-number :min="0" v-model="item.everyIncreaseCount" placeholder="请输入" type="number"/>
              <span v-if="RadioGroup == 0">
                件
              </span>
              <span v-if="RadioGroup == 1">
            ...
            <div>
              ...
              <a-input-number :min="0"  v-model="item.everyIncreasePrice" placeholder="请输入" type="number"/>
              <span>
                元
              </span>
          ...
          <div class="free-shipping" v-if="item.isDelivery == 1">
            ...
            <a-input-number :min="0" v-show="item.isConditionalPostage" v-model="item.satisfyPriceNumber" placeholder="请输入" type="number" style="margin-right: 10px" />

            <a-select   style="width:100px;margin-right: 10px;" v-model="item.unit" v-show="item.isConditionalPostage">
  ...
  export default{
    ...
    data(){
      return {
        ...
        supplyDefault:'',
        AllData:{
          sysAreaId:'',   //地址ID"1,2,3"
          sysUserId:'',  //供应商id
          placeDispatch:'',//地址名称“福建-厦门-思明区”
          name:'',      //模板名称
    ...
    created() {
      ...
      if (info) {
        ...
        //商品供应商回显
        this.selectSupply(info.sysUserId);
...
//      this.headers = {"X-Access-Token": token}
    ...
    methods: {
      ...
      onChange(checkedList) {
        ...
        console.log(checkedList,this.lastExemptionPostage)
          ...
          if(this.part ==  2){
            putAction(url,values).then((res)=>{
              if (res.code == 200){
                ...
                a.$router.push({path:"/provider/PlatformTemplateList"})
              }else {
