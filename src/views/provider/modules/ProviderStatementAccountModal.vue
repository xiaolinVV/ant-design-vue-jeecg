<template>
  <div>
    ...
    <!--详情信息-->
    <a-modal title="详情" :footer="null" :width="1400" v-model="visiblParticularsInformation"
             @ok="hideModalDistributionInformation()" okText="确认" cancelText="取消">
      <div>
...
<script>
  ...
  export default {
    name: 'ProviderStatementAccountModal',
    ...
    data() {
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            customRender: function(record) {
              return `${record.payType_dictText}【${record.orderNo}】`
            }
          }
        ...
        validatorRules: {},
        url: {
          add: '/providerStatementAccount/providerStatementAccount/add',
          edit: '/providerStatementAccount/providerStatementAccount/edit',
          getProviderAccountCapitalListList: '/providerStatementAccount/providerStatementAccount/getProviderAccountCapitalListList'
        }
      }
    },
    created() {
    ...
    methods: {
      ...
      showModalParticularsInformation(id) {
        ...
        if (!id) {
          ...
          this.providerAccountCapitalId = id
        }
        this.visiblParticularsInformation = true

        getAction(this.url.getProviderAccountCapitalListList, {
          id: id,
      ...
      loadData(arg) {
        ...
        if (!this.providerAccountCapitalId) {
          return
        }
        ...
        this.loading = true
        getAction(this.url.getProviderAccountCapitalListList, {
          id: this.providerAccountCapitalId,
          pageNo: this.ipagination.current,
          pageSize: this.ipagination.pageSize
        }).then((res) => {
          if (res.success) {
