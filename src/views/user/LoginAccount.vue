<template>
  <div>
    <a-form-model ref="form" :model="model" :rules="validatorRules" :hideRequiredMark="true">
      <a-form-model-item required prop="username" label="账户" :colon="false">
        <a-input v-model="model.username" size="large" placeholder="请输入帐户名 / admin">
          <!-- <a-icon slot="prefix" type="user" :style="{ color: 'rgba(0,0,0,.25)' }"/> -->
        </a-input>
      </a-form-model-item>
      <a-form-model-item required prop="password" label="密码" :colon="false">
