    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="账户余额">
          <a-input-number v-decorator="[ 'blance', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
...
<script>
  ...
  export default {
    name: "SysBlanceCapitalDetailModal",
    data () {
      return {
        title:"操作",
        visible: false,
        ...
        url: {
          add: "/system/sysBlanceCapitalDetail/add",
          edit: "/system/sysBlanceCapitalDetail/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','serialNumber','tradeType','goAndCome','amount','blance','tradeNo'))
		  //时间格式化
