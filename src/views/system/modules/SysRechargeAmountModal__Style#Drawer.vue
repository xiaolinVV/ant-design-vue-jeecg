  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/system/sysRechargeAmount/add",
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','serialNumber','money','sort','status','statusExplain'))
		  //时间格式化
        });
