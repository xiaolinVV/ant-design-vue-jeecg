  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','serialNumber','ticketName','mainPicture','preferentialTime','timeType','effectiveDays','status','statusExplain'))
		  //时间格式化
        });
