<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('订单-店铺订单-待付款订单')">导出</a-button>
    </div>
    <!-- <div class="table-operator">
...
export default {
  ...
  methods: {
    ...
    //商品信息
    showModalGoodsInformation(orderStoreSubListDTOs) {
      this.$refs.modalForm.showModalGoodsInformation(orderStoreSubListDTOs)
    ...
    particulars(record, reusePage) {
      ...
      this.$router.push({ path: '/order/OrderStoreDetails', query: { record: record, reusePage: reusePage } }) //reusePage=2 为平台待付款详情
    },
