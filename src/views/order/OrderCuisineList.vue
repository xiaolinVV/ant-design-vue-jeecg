<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('菜单订单')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <orderCuisine-modal ref="modalForm" @ok="modalFormOk"></orderCuisine-modal>
  </a-card>
</template>

<script>
  import OrderCuisineModal from './modules/OrderCuisineModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'

  export default {
    name: "OrderCuisineList",
    ...
    data () {
      return {
        ...
        columns: [
          {
		   ...
		   {
            title: '结算方式；0：未结算；1：客户结算；2：商户结算',
            align:"center",
            dataIndex: 'clearingForm'
           },
		   {
            title: '状态；0：代付款；1：已付款；2：取消',
            align:"center",
            dataIndex: 'status'
           },
		   {
		...
		url: {
          list: "/order/orderCuisine/list",
          delete: "/order/orderCuisine/delete",
          deleteBatch: "/order/orderCuisine/deleteBatch",
          exportXlsUrl: "order/orderCuisine/exportXls",
          importExcelUrl: "order/orderCuisine/importExcel",
       },
    }
  },
  computed: {
