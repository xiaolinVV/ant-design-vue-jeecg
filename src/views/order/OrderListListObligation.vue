<template>
  <a-card :bordered="false">
    ...
    <!--<a-button type="primary" icon="download"  :loading="exportLoading"  @click="orderListExport(0)">导出预览</a-button>-->
    <!--</div>-->

    <!-- 操作按钮区域 -->
    <div class="table-operator">
      <a-button type="primary" icon="download"  :loading="exportLoading"  @click="handleExportXls('订单-平台订单-待付款订单')">导出</a-button>
    </div>
  ...
  data() {
    return {
      ...
      url: {
        ...
        exportXlsUrl: 'orderList/orderList/exportPageListObligation',
