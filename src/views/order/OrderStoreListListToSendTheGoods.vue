<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download"  :loading="exportLoading"  @click="handleExportXls('订单-店铺订单-待发货订单')">导出</a-button>
    </div>
    <!--<div class="table-operator">
    ...
    <div>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-divider type="vertical" v-if="record.isSender == 1" />
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/orderStoreList/orderStoreList/queryPageListToSendTheGoods',
        delete: '/orderStoreList/orderStoreList/delete',
        deleteBatch: '/orderStoreList/orderStoreList/deleteBatch',
        exportXlsUrl: 'orderStoreList/orderStoreList/exportPageListToSendTheGoods',
  ...
  methods: {
    ...
    particulars(record, reusePage) {
      ...
      this.$router.push({ path: '/order/OrderStoreDetails', query: { record: record, reusePage: reusePage } }) //reusePage=3
    },
    //发货
    deliverGoods(record) {
