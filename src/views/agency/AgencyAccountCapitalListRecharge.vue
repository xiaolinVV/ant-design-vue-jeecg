<template>
  <a-card :bordered="false">
    ...
    <!--  <a-button type="primary" icon="download"  :loading="exportLoading"  @click="handleExportXls('代理资金流水')">导出</a-button>-->
...
<script>
  ...
  export default {
    name: "AgencyAccountCapitalListRecharge",
    ...
    data () {
      return {
		...
		url: {
          list: "/agencyRechargeRecord/agencyRechargeRecord/findRechargeRecord",
