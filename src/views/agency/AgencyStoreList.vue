    ...
    <div>
      ...
      <a-table
        ...
        <template slot="avatarslot1" slot-scope="text, record, index">
          <img class="clickShowImage" :preview="'avatarslot1' + index" :src="getAvatarView1(record.storePicture)" alt=""
               style="width: 32px;height: 32px;display:block">
        </template>
        <template slot="avatarslot2" slot-scope="text, record, index">
          <img class="clickShowImage" :preview="'avatarslot2' + index" :src="getAvatarView2(record.accordingStore)"
               alt="" style="width: 32px;height: 32px;display:block">
        </template>
        <template slot="avatarslot3" slot-scope="text, record, index">
          <img class="clickShowImage" :preview="'avatarslot3' + index"
               :src="getAvatarView3(record.licenseForEnterprise)" alt="" style="width: 32px;height: 32px;display:block"
        ...
        <template slot="avatarslot4" slot-scope="text, record, index">
          <img class="clickShowImage" :preview="'avatarslot4' + index" :src="getAvatarView4(record.idPictureZ)" alt=""
               style="width: 32px;height: 32px;display:block">
        </template>
        <template slot="avatarslot5" slot-scope="text, record, index">
          <img class="clickShowImage" :preview="'avatarslot5' + index" :src="getAvatarView5(record.idPictureF)" alt=""
               style="width: 32px;height: 32px;display:block">
        </template>
        <template slot="avatarslot6" slot-scope="text, record, index">
          <img class="clickShowImage" :preview="'avatarslot6' + index" :src="getAvatarView6(record.idHand)" alt=""
               style="width: 32px;height: 32px;display:block">
        </template>
        <template slot="avatarslot7" slot-scope="text, record, index">
          <img class="clickShowImage" :preview="'avatarslot7' + index" :src="getAvatarView7(record.agentAuthorization)"
               alt="" style="width: 32px;height: 32px;display:block" v-if="record.agentAuthorization!=null">
