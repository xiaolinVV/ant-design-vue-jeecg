<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <!-- <a-button type="primary" icon="download"  :loading="exportLoading"  @click="handleExportXls('代理提现审批')">导出</a-button>-->
    ...
    <!-- 表单区域 -->
    <agencySettleAccounts-modal ref="modalForm" @ok="modalFormOk"></agencySettleAccounts-modal>
  </a-card>
</template>

<script>
import AgencySettleAccountsModal from './modules/AgencySettleAccountsModal'
import { JeecgListMixin } from '@/mixins/JeecgListMixin'
import { filterObj } from '@/utils/util'
export default {
  name: 'AgencySettleAccountsList',
  mixins: [JeecgListMixin],
  components: {
    AgencySettleAccountsModal
  },
  data() {
    return {
      description: '代理提现审批管理页面',
      // 表头
      columns: [
        {
          title: '#',
      ...
      url: {
        ...
        delete: '/agencySettleAccounts/agencySettleAccounts/delete',
        deleteBatch: '/agencySettleAccounts/agencySettleAccounts/deleteBatch',
        exportXlsUrl: 'agencySettleAccounts/agencySettleAccounts/exportXls',
        importExcelUrl: 'agencySettleAccounts/agencySettleAccounts/importExcel'
      }
    }
  },
  computed: {
