<template>
  <a-card :bordered="false">
    ...
    <!--<div class="table-operator">
      ...
      <a-button type="primary" icon="download"  :loading="exportLoading"  @click="handleExportXls('代理银行卡')">导出</a-button>
    ...
    <div>
      ...
      >
        <template slot="avatar" slot-scope="text, record, index">
          <img class="clickShowImage" :preview="'avatar' + index" :src="ssAddressView(record.avatar)" alt="" />
        </template>
    ...
    <publicCorrespondentCardsEditModal
      ref="modalForm"
      @ok="modalFormOk"
      urlEditName="agencyBankCard/agencyBankCard/edit"
    ></publicCorrespondentCardsEditModal>
  </a-card>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/agencyBankCard/agencyBankCard/list',
        delete: '/agencyBankCard/agencyBankCard/delete',
        deleteBatch: '/agencyBankCard/agencyBankCard/deleteBatch',
        exportXlsUrl: 'agencyBankCard/agencyBankCard/exportXls',
        importExcelUrl: 'agencyBankCard/agencyBankCard/importExcel',
