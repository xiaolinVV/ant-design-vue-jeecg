...
<script>
  ...
  export default {
    name: "AgencySettleAccountsModal",
    data () {
      return {
        title: "操作",
        visible: false,
        ...
        validatorRules: {},
        url: {
          add: "/agencySettleAccounts/agencySettleAccounts/add",
          edit: "/agencySettleAccounts/agencySettleAccounts/edit",
          updateAuditStatus: "/agencySettleAccounts/agencySettleAccounts/updateAuditStatus",//弃用
          updateStatusRemit: "/agencySettleAccounts/agencySettleAccounts/updateStatusRemit",//弃用
          audit: "/agencySettleAccounts/agencySettleAccounts/audit",//审核
          remit: "/agencySettleAccounts/agencySettleAccounts/remit"//打款
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      hideAudiModal() {
        ...
        postAction(that.url.audit, {
          id: that.AgencySettleAccountsId, closeExplain: that.closeExplain, status: that.status, orderNo: that.orderNo,
