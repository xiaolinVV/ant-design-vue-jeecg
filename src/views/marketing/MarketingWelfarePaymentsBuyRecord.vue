...
export default {
  name: 'MarketingWelfarePaymentsBuyRecord',
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          title: `购买${this.welfareBabelName}`,
          align: 'center',
          dataIndex: 'bargainPayments'
        },
        {
          title: `${this.welfareBabelName}支付`,
          align: 'center',
      ...
      url: {
        list: '/marketingWelfarePayments/marketingWelfarePayments/findWelfarePaymentsBuy',
