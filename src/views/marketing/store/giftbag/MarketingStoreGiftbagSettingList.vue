    ...
    data() {
      return {
        ...
        url: Object.freeze({
          ...
          addOrEdit: '/marketing.store.giftbag/marketingStoreGiftbagSetting/addOrEdit', //设置
          queryByOne: '/marketing.store.giftbag/marketingStoreGiftbagSetting/queryByOne' ,//返显
