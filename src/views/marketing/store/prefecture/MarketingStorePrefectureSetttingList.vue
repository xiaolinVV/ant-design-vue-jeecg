  ...
  <div class="MarketingGroupIntegralBaseSetting">
    ...
    <a-form :form="form" class="wrap">
      <a-form-item :label-col="labelCol" :wrapper-col="wrapperCol" label="活动别名">
        <a-input placeholder="请输入活动别名" style="width:300px;" v-decorator="rules.anotherName"> </a-input>
      </a-form-item>
...
<script>
  ...
  export default {
    name: 'MarketingStoreGiftbagSettingList',
    components: {
      JEditor
    },
    data() {
      return {
        ...
        url: Object.freeze({
          ...
          addOrEdit: '/marketing.store.prefecture/marketingStorePrefectureSettting/addOrEdit', //设置
          queryByOne: '/marketing.store.prefecture/marketingStorePrefectureSettting/queryByOne' ,//返显
