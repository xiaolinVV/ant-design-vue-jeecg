<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download"  :loading="exportLoading"  @click="handleExportXls('拼团广告')">导出</a-button>
      <a-upload
        name="file"
        ...
        <template slot="address" slot-scope="text, record">
          ...
          <div v-else>
            <img
              ...
              v-if="text != undefined"
              :preview="'image' + index"
              :src="getAvatarView(JSON.parse(text)[0])"
              alt=""
            />
    ...
    <!-- 表单区域 -->
    <MarketingGroupAdvertising-modal ref="modalForm" @ok="modalFormOk"></MarketingGroupAdvertising-modal>
    <a-modal title="启动后广告，该广告将可以访问。" v-model="visible" @ok="hideModal()" okText="确认" cancelText="取消">
      <p>您确定要停用吗？</p>
...
<script>
import MarketingGroupAdvertisingModal from './modules/MarketingGroupAdvertisingModal'
import { JeecgListMixin } from '@/mixins/JeecgListMixin'
import { httpAction, getAction, postAction, putAction } from '@/api/manage'

export default {
  name: 'MarketingGroupAdvertisingList',
  mixins: [JeecgListMixin],
  components: {
    MarketingGroupAdvertisingModal
  },
  data() {
    return {
      ...
      url: {
        list: '/marketing/marketingGroupAdvertising/list',
        delete: '/marketing/marketingGroupAdvertising/delete',
        deleteBatch: '/marketing/marketingGroupAdvertising/deleteBatch',
        exportXlsUrl: 'marketing/marketingGroupAdvertising/exportXls',
        importExcelUrl: 'marketing/marketingGroupAdvertising/importExcel',
