        ...
        <a-row :gutter="24">
          ...
          <a-col :md="8" :sm="8">
            <a-form-item label="交易类型">
              <j-dict-select-tag v-model="queryParam.payType" placeholder="请选择" dictCode="free_points_deal_type" />
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="8">
...
export default {
  ...
  data() {
    return {
      ...
      queryParam2: {},
      url: {
        list: '/marketing/marketingIntegralRecord/list',
        delete: '/marketing/marketingIntegralRecord/delete',
        deleteBatch: '/marketing/marketingIntegralRecord/deleteBatch',
        exportXlsUrl: 'marketing/marketingIntegralRecord/exportXls',
        importExcelUrl: 'marketing/marketingIntegralRecord/importExcel'
      }
    }
  },
  computed: {
