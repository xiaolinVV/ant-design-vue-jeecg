  ...
  <a-card :bordered="false">
            ...
            <a-col :md="8" :sm="8">
              <a-form-item label="交易类型">
                <j-dict-select-tag v-model="queryParam.tradeType" placeholder="请选择"
                                   dictCode="welfare_deal_type"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="8">
              <a-form-item label="收入/支出">
                <a-select v-model="queryParam.weType " placeholder="请选择类型">
    ...
    <div>
      ...
      <a-table
        ...
        <template slot="weType" slot-scope="text, record, index">
          <div class="anty-img-wrap">
            <span shape="square" v-if="record.weType==0" >支出</span>
            <span shape="square" v-if="record.weType==1" >收入</span>
          </div>
        </template>
...
<script>
  ...
  export default {
    name: "MarketingWelfarePaymentsList",
    ...
    data () {
      return {
        ...
        url: {
          list: "/marketingWelfarePayments/marketingWelfarePayments/findStoreWelfarePaymentsList",
