<template>
  <div class="MarketingForthIntegralSetting">
    <div class="title">
      积分设置
    </div>
...
export default {
  name: 'MarketingForthIntegralSetting',
  data() {
    return {
      headers: '',
      ...
      url: Object.freeze({
        ...
        setMarketingIntegralSetting: '/marketing/marketingFourthIntegralSetting/addOrEdit', //新增编辑
        returnMarketingIntegralSetting: '/marketing/marketingFourthIntegralSetting/queryByOne' //返现
      }),
      //配置
      configure: {
        imgErver: window._CONFIG['domianURL'] + '/sys/common/view',
