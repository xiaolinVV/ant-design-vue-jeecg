<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <!-- <a-button type="primary" icon="download"  :loading="exportLoading"  @click="handleExportXls('积分任务')">导出</a-button>
    ...
    <div>
      ...
      >
        ...
        <template slot="isView" slot-scope="text">
          <div class="anty-img-wrap">
            <span shape="square" v-if="text == 0">不显示</span>
            <span shape="square" v-if="text == 1">显示</span>
          </div>
        </template>
...
export default {
  name: 'MarketingIntegralTaskList',
