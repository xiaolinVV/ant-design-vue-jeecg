<template>
  <div class="MarketingCertificateSeckillListList">
      ...
      <a-card :bordered="false" style="width: 79%;min-height: 700px;background: white;float: right;">
        ...
        <div class="table-page-search-wrapper">
          <a-form layout="inline">
            <a-row :gutter="24">
              ...
              <a-col :md="8" :sm="8">
                <a-form-item label="是否限购">
                  <a-select v-model="queryParam.purchase" placeholder="请选择是否限购">
                    <a-select-option value="">请选择</a-select-option>
        ...
        <div>
          ...
          >
            ...
            <template slot="discountActivity" slot-scope="text, record">
              {{ handleDiscountActivity(record) }}
            </template>
...
export default {
  ...
  data() {
    return {
      ...
      modalForm2Infos: {},
      url: {
        list: '/marketingCertificateSeckillList/marketingCertificateSeckillList/list',
  ...
  methods: {
    ...
    handleDiscountActivity(record) {
      //  record.discountActivity  = record.activityPrice /  record.price * 100
      let result = (record.activityPrice / record.price) * 100
      if (result) {
    ...
    toEdit() {
      this.$router.push({
        path: '/marketing/modules/MarketingCertificateSeckillListAdd',
        query: { marketingCertificateSeckillActivityListId: this.marketingCertificateSeckillActivityListId }
      })
    },
...
<style lang="less">
.MarketingCertificateSeckillListList {
  .select-color {
    color: #1890ff;
  }
