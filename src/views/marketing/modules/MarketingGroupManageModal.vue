    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="商品主图相对地址（以json的形式存储多张）">
          <a-input placeholder="请输入商品主图相对地址（以json的形式存储多张）" v-decorator="['mainPicture', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="拼团商品id">
          <a-input placeholder="请输入拼团商品id" v-decorator="['marketingGroupGoodListId', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="建团时间">
          <a-date-picker showTime format='YYYY-MM-DD HH:mm:ss' v-decorator="[ 'buildTime', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
...
<script>
  ...
  export default {
    name: "MarketingGroupManageModal",
    data () {
      return {
        title:"操作",
        visible: false,
        ...
        url: {
          add: "/marketing/marketingGroupManage/add",
          edit: "/marketing/marketingGroupManage/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','groupNo','goodNo','mainPicture','goodName','marketingGroupGoodListId','marketPrice','smallPrice','activityPrice','numberTuxedo','status'))
		  //时间格式化
          this.form.setFieldsValue({startTime:this.model.startTime?moment(this.model.startTime):null})
          this.form.setFieldsValue({endTime:this.model.endTime?moment(this.model.endTime):null})
          this.form.setFieldsValue({buildTime:this.model.buildTime?moment(this.model.buildTime):null})
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            formData.buildTime = formData.buildTime?formData.buildTime.format('YYYY-MM-DD HH:mm:ss'):null;
