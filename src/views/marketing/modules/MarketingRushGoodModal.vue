    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="抢购分类id">
          <a-input placeholder="请输入抢购分类id" v-decorator="['marketingRushTypeId', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="平台商品id">
          <a-input placeholder="请输入平台商品id" v-decorator="['goodListId', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/marketingRushGood/marketingRushGood/add",
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','marketingRushTypeId','goodListId','price','sort','status','statusExplain','delExplain'))
		  //时间格式化
        });
