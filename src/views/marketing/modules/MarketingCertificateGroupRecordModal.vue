    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="拼好券团管理id">
          <a-input placeholder="请输入拼好券团管理id" v-decorator="['marketingCertificateGroupManageId', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="参团编号">
          <a-input placeholder="请输入参团编号" v-decorator="['tuxedoNumber', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          <a-input placeholder="请输入拼团身份；0：参与人；1：发起人" v-decorator="['groupIdentity', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
...
<script>
  ...
  export default {
    name: "MarketingCertificateGroupRecordModal",
    data () {
      return {
        title:"操作",
        visible: false,
        ...
        url: {
          add: "/marketingCertificateGroupRecord/marketingCertificateGroupRecord/add",
          edit: "/marketingCertificateGroupRecord/marketingCertificateGroupRecord/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','marketingCertificateGroupManageId','tuxedoNumber','marketingCertificateGroupListId','certificateName','mainPicture','marketPrice','price','costPrice','activityPrice','memberListId','groupIdentity','status'))
		  //时间格式化
