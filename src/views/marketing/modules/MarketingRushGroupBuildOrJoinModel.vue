...
export default {
  name: 'MarketingZoneGroupBuildOrJoinModel',
  ...
  data() {
    return {
      ...
      url: {
        //参团次数明细
        list: '/marketingZoneSpellGroupRecord/marketingZoneSpellGroupRecord/list'
  ...
  methods: {
    ...
    getQueryParams() {
      var param = Object.assign({}, this.queryParam, this.isorter, { marketingZoneGroupTimeId: this.model.id })
    ...
    async showModal(record) {
      ...
      if (record.reqType == 1) {
        //建团次数明细
        this.title = '建团次数明细'
        this.url.list = '/marketingZoneGroupNumberRecord/marketingZoneGroupNumberRecord/list'
      } else if (record.reqType == 2) {
        //参团次数明细
        this.title = '参团次数明细'
        this.url.list = '/marketingZoneSpellGroupRecord/marketingZoneSpellGroupRecord/list'
      }
      this.visible = true
      await this.$nextTick()
      this.loadData()
