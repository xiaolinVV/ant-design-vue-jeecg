  ...
  >
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="活动别名">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="支付方式；0：产品券">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="状态；0：进行中；1：已成功；2：已失败">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="拼购管理id">
          <a-input placeholder="请输入拼购管理id" v-decorator="['marketingGroupIntegralManageId', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="拼购编号">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="失败时间">
      ...
      this.$nextTick(() => {
        this.form.setFieldsValue(
          pick(
            ...
            'status',
            'statusExplain',
            'marketingGroupIntegralManageId',
            'serialNumber'
          )
        )
        //时间格式化
