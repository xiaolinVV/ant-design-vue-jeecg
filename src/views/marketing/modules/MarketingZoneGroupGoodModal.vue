    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="排序">
          <a-input-number v-decorator="['sort', { rules: [{ required: true, message: '请输入排序' }] }]" />
        </a-form-item>
        <!-- <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
...
export default {
  name: 'MarketingZoneGroupGoodModal',
  data() {
    return {
      title: '操作',
      visible: false,
      ...
      validatorRules: {},
      url: {
        add: '/marketingZoneGroupGood/marketingZoneGroupGood/add',
