    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="状态：0：关闭；1：启用">
          <a-input placeholder="请输入状态：0：关闭；1：启用" v-decorator="['status', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="活动次数">
          <a-input-number v-decorator="[ 'times', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="首页广告图">
          <a-input placeholder="请输入首页广告图" v-decorator="['adIndexAddr', {}]" />
        </a-form-item>
...
<script>
  ...
  export default {
    name: "MarketingGroupIntegralBaseSettingModal",
    data () {
      return {
        title:"操作",
        visible: false,
        ...
        url: {
          add: "/marketing/marketingGroupIntegralBaseSetting/add",
          edit: "/marketing/marketingGroupIntegralBaseSetting/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','anotherName','pointsDisplay','ruleDescription','status','times','adIndexAddr'))
		  //时间格式化
