...
<script>
  ...
  export default {
    name: "MarketingFourthIntegralRecordModal",
    data () {
      return {
        title:"操作",
        visible: false,
        ...
        url: {
          add: "/marketing/marketingFourthIntegralRecord/add",
          edit: "/marketing/marketingFourthIntegralRecord/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','memberListId','serialNumber','tradeType','goAndCome','integral','tradeNo','integralBalance'))
		  //时间格式化
