          ...
          <a-row :gutter="24">
            ...
            <a-col :md="24">
              ...
              >
                ...
                <template slot="marketingFreeGoodListCount" slot-scope="text">
                  <div v-if="text > 0">
                    已加入
                  </div>
                  <div v-else>
...
const columnSecond = [
  ...
  {
    title: '状态',
    dataIndex: 'marketingFreeGoodListCount',
    align: 'center',
    scopedSlots: { customRender: 'marketingFreeGoodListCount' }
  },
  {
    title: '市场价',
    dataIndex: 'marketPrice',
    ...
    rowSelection({ types }) {
      return {
        ...
        getCheckboxProps: record => ({
          props: {
            disabled: record.marketingFreeGoodListCount != 0 && types == 1, // Column configuration not to be checked
            name: record.name
          }
        })
      }
