    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="称号名称">
          <a-input placeholder="请输入称号" :disabled="true" v-decorator="['identityName', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="级别">
          <a-input-number :disabled="true" v-decorator="['grade', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="发展奖励">
          <a-input-number v-decorator="['developmentReward', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="推荐奖励">
          <a-input-number v-decorator="['referralBonuses', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="达标奖励">
          <a-input-number v-decorator="['standardReward', {}]" />
        </a-form-item>
      </a-form>
    </a-spin>
  </a-modal>
...
export default {
  name: 'MarketingBusinessGiftIdentityModal',
  data() {
    return {
      title: '操作',
      visible: false,
      ...
      validatorRules: {},
      url: {
        add: '/marketing/marketingBusinessGiftIdentity/add',
        edit: '/marketing/marketingBusinessGiftIdentity/edit'
      }
    }
  },
  created() {},
