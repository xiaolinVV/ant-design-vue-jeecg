    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="免单活动商品类型id">
          <a-input placeholder="请输入免单活动商品类型id" v-decorator="['marketingFreeGoodTypeId', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/marketing/marketingFreeGoodList/add",
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','marketingFreeGoodTypeId','goodListId','isRecommend','status','statusExplain'))
		  //时间格式化
        });
