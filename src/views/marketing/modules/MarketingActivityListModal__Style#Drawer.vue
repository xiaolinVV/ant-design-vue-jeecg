  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','activityName','places','sysAreaIds','detailedAddress','phone','coverPlan','posters','surfacePlot','content','status','statusExplain','sysAreaExplain','serialNumber'))
		  //时间格式化
