    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="礼包列表id">
          <a-input placeholder="请输入礼包列表id" v-decorator="['marketingBusinessGiftListId', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="推荐人id">
          <a-input placeholder="请输入推荐人id" v-decorator="['tMemberId', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
...
<script>
  ...
  export default {
    name: "MarketingBusinessGiftRecordModal",
    data () {
      return {
        title:"操作",
        visible: false,
        ...
        url: {
          add: "/marketingBusinessGiftRecord/marketingBusinessGiftRecord/add",
          edit: "/marketingBusinessGiftRecord/marketingBusinessGiftRecord/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','marketingBusinessGiftListId','serialNumber','memberListId','giftName','salesPrice','tMemberId','referralBonuses','tradeNo'))
		  //时间格式化
