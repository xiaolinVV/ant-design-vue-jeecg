...
<script>
  ...
  export default {
    name: "MarketingIntegralRecordModal",
    data () {
      return {
        title:"操作",
        visible: false,
        ...
        url: {
          add: "/marketing/marketingIntegralRecord/add",
          edit: "/marketing/marketingIntegralRecord/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','memberListId','serialNumber','tradeType','goAndCome','integral'))
		  //时间格式化
