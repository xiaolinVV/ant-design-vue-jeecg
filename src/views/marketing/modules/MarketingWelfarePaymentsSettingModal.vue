    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="比例">
          <a-input-number v-decorator="[ 'proportion', {}]" />
        </a-form-item>
      </a-form>
    </a-spin>
  </a-modal>
...
<script>
  ...
  export default {
    name: "MarketingWelfarePaymentsSettingModal",
    data () {
      return {
        title:"操作",
        visible: false,
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','nickName','proportion','topicMap','status'))
		  //时间格式化
        });
