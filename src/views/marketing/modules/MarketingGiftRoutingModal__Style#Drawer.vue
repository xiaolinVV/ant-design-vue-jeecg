    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="礼包列表id">
          <a-input placeholder="请输入礼包列表id" v-decorator="['marketingGiftBagId', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="账户类型；（0：对私；1：对公）">
          <a-input placeholder="请输入账户类型；（0：对私；1：对公）" v-decorator="['accountType', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="汇付天下分账结算账户id">
          <a-input placeholder="请输入汇付天下分账结算账户id" v-decorator="['settleAccount', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','marketingGiftBagId','accountType','bankCard','realName','idNumber','phone','settleAccount'))
		  //时间格式化
        });
