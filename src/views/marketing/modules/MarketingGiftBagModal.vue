    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="vip特权；0：不赠送；1：赠送：">
          <a-input placeholder="请输入vip特权；0：不赠送；1：赠送：" v-decorator="['vipPrivilege', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="会员类型，按照字典,逗号隔开">
          <a-input placeholder="请输入会员类型，按照字典,逗号隔开" v-decorator="['buyLimit', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="每人限制购买次数">
          <a-input-number v-decorator="[ 'limitTimes', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','giftName','price','welfarePayments','distributionCommission','vipPrivilege','buyLimit','limitTimes','viewScope','giftExplain','status','closeExplain'))
		  //时间格式化
