...
export default {
  name: 'MarketingCertificateSeckillActivityListModal',
  data() {
    return {
      title: '操作',
      visible: false,
      ...
      url: {
        add: '/marketingCertificateSeckillActivityList/marketingCertificateSeckillActivityList/add',
  ...
  methods: {
    ...
    edit(record) {
      ...
      this.visible = true
      this.$nextTick(() => {
        this.form.setFieldsValue(pick(this.model, 'startTime', 'endTime', 'status'))
        //时间格式化
