    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="公告标题">
          <a-input placeholder="请输入公告标题" v-decorator="['announcementTitle', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="是否强推；0：否；1：是">
          <a-input placeholder="请输入是否强推；0：否；1：是" v-decorator="['strongPush', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'year','month','day','delFlag','announcementTitle','content','strongPush'))
		  //时间格式化
        });
