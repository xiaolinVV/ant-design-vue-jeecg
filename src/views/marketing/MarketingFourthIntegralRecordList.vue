...
export default {
  ...
  data() {
    return {
      ...
      queryParam2: {},
      url: {
        list: '/marketing/marketingFourthIntegralRecord/list',
        delete: '/marketing/marketingFourthIntegralRecord/delete',
        deleteBatch: '/marketing/marketingFourthIntegralRecord/deleteBatch',
        exportXlsUrl: 'marketing/marketingFourthIntegralRecord/exportXls',
        importExcelUrl: 'marketing/marketingFourthIntegralRecord/importExcel'
      }
    }
  },
  computed: {
