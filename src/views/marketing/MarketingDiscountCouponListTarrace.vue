...
<template>
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="24">
          ...
          <a-col :md="24" :sm="8">
            <a-button type="primary" @click="sendCouponModel" icon="plus" >送优惠券</a-button>
          </a-col>
        </a-row>
      </a-form>
    </div>
    ...
    <marketing-discount-couponList-tarrace-send-couponModel ref="MarketingDiscountCouponListTarraceSendCouponModel" @success="loadData">
...
<script>
  ...
  import MarketingDiscountCouponListTarraceSendCouponModel from './modules/MarketingDiscountCouponListTarraceSendCouponModel'
  export default {
    name: "MarketingDiscountCouponListTarrace",
    ...
    data () {
      return {
        ...
        url: {
          list: "/marketingDiscountCoupon/marketingDiscountCoupon/findDiscountCouponTarrace",
