        ...
        <a-row :gutter="24">
          <a-col :md="8" :sm="8">
            <a-form-item label="优惠券id">
              <a-input placeholder="" v-model="queryParam.id" placeholder="请输入"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="8">
            <a-form-item label="优惠券名称">
              <a-input placeholder="" v-model="queryParam.name" placeholder="请输入"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="8">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :md="8" :sm="8">
              <a-form-item label="店铺名称">
                <a-input placeholder="" v-model="queryParam.storeName" placeholder="请输入"></a-input>
              </a-form-item>
            </a-col>
          </template>
          <a-col :md="6" :sm="8">
    ...
    <div>
      ...
      >
        ...
        <template slot="channelInfo" slot-scope="text, record, index">
          <div class="anty-img-wrap">
            <a v-if="record.isNomal == 0" @click="showChannelInfo(record.id)">{{ record.channelInfo }}</a>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/marketingDiscount/marketingDiscount/getMarketingDiscountStoreList',
  ...
  methods: {
    ...
    addTemplate(part, item = '') {
      ...
      // debugger;
      if (part == 2) {
        localStorage.setItem('marketingDiscountData', JSON.stringify(item))
      } else {
        localStorage.removeItem('marketingDiscountData')
      }
      this.$router.push({ path: '/marketing/modules/AddMarketingDiscountStoreModel', query: { part } })
    },
    //删除说明弹窗
    deleteById() {
      this.visible1 = false
    ...
    showGoodInformation(id) {
      ...
      // this.$refs.modalForm.title = "适用商品";
      // this.$refs.modalForm.disableSubmit = false;
    },
    showChannelInfo(id) {
      this.$refs.modalForm.showChannelInfoModel(id)
      this.$refs.modalForm.title = '投放渠道'
      this.$refs.modalForm.disableSubmit = '投放渠道'
    },
