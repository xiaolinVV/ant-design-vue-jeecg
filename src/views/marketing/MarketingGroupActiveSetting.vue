  ...
  <div class="MarketingGroupActiveSetting">
    ...
    <a-form :form="form" class="wrap">
      ...
      <a-form-item :label-col="labelCol" :wrapper-col="wrapperCol" label="设置推荐数量">
        <a-input-number :min="1" placeholder="请输入推荐数量" style="width: 200px;" v-decorator="rules.recommendCount">
        </a-input-number>
      </a-form-item>
      ...
      <a-form-item :label-col="labelCol" :wrapper-col="wrapperCol" label="商品购买资格有效期">
        <a-input-number placeholder="有效期" v-decorator="rules.validity" :min="1" :precision="0" />
        小时
      </a-form-item>
...
export default {
  name: 'MarketingGroupActiveSetting',
  data() {
    return {
      headers: '',
      ...
      rules: Object.freeze({
        ...
        validity: ['validity', { rules: [{ required: true, message: '请输入商品购买资格有效期' }] }],
      ...
      url: Object.freeze({
        ...
        addOrEdit: '/marketing/marketingGroupBaseSetting/add', //新增编辑
        queryByOne: '/marketing/marketingGroupBaseSetting/queryByOne' //返现
      }),
      //配置
