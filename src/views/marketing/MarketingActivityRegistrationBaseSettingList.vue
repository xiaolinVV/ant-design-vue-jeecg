<template>
  <div class="MarketingActivityRegistrationBaseSetting">
    <div class="title">
      基础设置
    </div>
...
export default {
  name: 'MarketingActivityRegistrationBaseSetting',
  data() {
    return {
      headers: '',
      ...
      url: Object.freeze({
        ...
        addOrEdit: '/marketing/marketingActivityRegistrationBaseSetting/addOrEdit', //新增编辑
        queryByOne: '/marketing/marketingActivityRegistrationBaseSetting/queryByOne' //返现
      }),
      //配置
...
<style lang="less">
.MarketingActivityRegistrationBaseSetting {
	width: 100%;
	background: white;
