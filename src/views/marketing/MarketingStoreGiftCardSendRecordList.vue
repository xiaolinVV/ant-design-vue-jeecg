        ...
        <a-row :gutter="24">
          ...
          <a-col :md="8" :sm="8">
            <a-form-item label="赠送人手机号">
              <a-input placeholder="请输入" v-model="queryParam.givePhone"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="8">
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: 'marketing/marketingStoreGiftCardMemberList/giveList',
