...
<template>
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            <a-col :md="8" :sm="8">
              <a-form-item label="推荐人">
                <a-input placeholder="请输入" v-model="queryParam.pName"></a-input>
              </a-form-item>
            </a-col>
            <!--<a-col :md="8" :sm="8">
              <a-form-item label="分销状态">
                <a-input placeholder="" v-model="queryParam.status"></a-input>
              </a-form-item>
            </a-col>-->
            <a-col :md="8" :sm="8">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="plus" @click="handleExportXls('店铺分销设置')" v-has="'marketingStore:exportXls'">导出</a-button>
    ...
    <!-- table区域-end -->
    <!-- 表单区域 -->
    <marketingStoreDistributionSetting-modal ref="modalForm" @ok="modalFormOk"></marketingStoreDistributionSetting-modal>
...
<script>
  ...
  export default {
    name: "MarketingStoreDistributionSettingPageList",
    ...
    data () {
      return {
        ...
        url: {
          list: "/marketingStoreDistributionSetting/marketingStoreDistributionSetting/findStoreDistribution",
    ...
    methods: {
      ...
      getAvatarView1: function (address) {
