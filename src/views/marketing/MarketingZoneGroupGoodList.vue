<template>
  <div class="MarketingPrefectureGoodList">
    <div style="width:calc(100vw - 250px)">
        ...
        <a-spin :spinning="cardLoading">
          ...
          <a-list itemLayout="horizontal" :dataSource="listData">
            <div class="line-render-item" slot="renderItem" slot-scope="item, index" @click="loadData(item)">
              ...
              <div :class="{ 'select-color': item.id == marketingZoneGroupId }">
                {{ item.zoneName }}
              </div>
            </div>
          </a-list>
      ...
      <a-card :bordered="false" style="width: 79%;min-height: 700px;background: white;float: right">
        ...
        <div class="table-operator">
          <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
            <a-button type="primary" @click="loadData({ id: marketingZoneGroupId })" icon="search">查询</a-button>
            <a-button
              type="primary"
              @click="loadData({ id: marketingZoneGroupId }, false, true)"
              icon="reload"
      ...
      <MarketingZoneGroupGoodModal ref="modalForm" @ok="modalFormOk"></MarketingZoneGroupGoodModal>
      <div style="clear: both"></div>
    </div>
  </div>
</template>
...
import MarketingZoneGroupGoodModal from './modules/MarketingZoneGroupGoodModal'
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        edit: 'marketingZoneGroupGood/marketingZoneGroupGood/edit',
        list: '/marketingZoneGroupGood/marketingZoneGroupGood/list',
        delete: '/marketingZoneGroupGood/marketingZoneGroupGood/delete',
