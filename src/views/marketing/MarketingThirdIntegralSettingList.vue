<template>
  <div class="MarketingThirdIntegralSetting">
    <div class="title">
      积分设置
    </div>
...
export default {
  name: 'MarketingThirdIntegralSetting',
  data() {
    return {
      headers: '',
      ...
      url: Object.freeze({
        ...
        setMarketingIntegralSetting: '/marketing/marketingThirdIntegralSetting/addOrEdit', //新增编辑
        returnMarketingIntegralSetting: '/marketing/marketingThirdIntegralSetting/queryByOne' //返现
      }),
      //配置
      configure: {
        imgErver: window._CONFIG['domianURL'] + '/sys/common/view',
