<template>
  <div class="MarketingLeagueSetting">
    <div class="title">
      基础设置
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      //接口
      url: {
        addOrEdit: '/marketing/marketingLeagueSetting/addOrEdit', //新增编辑
        queryByOne: '/marketing/marketingLeagueSetting/queryByOne' //返现
      }
    }
  },
  components: {
